...
from analysis import clas_accuracy as clas_analysis
from datasets import multiclas
...
if __name__ == '__main__':
    ...
    ((trX, trY), (vaX, vaY), (teX, )) = encode_dataset(*multiclas(data_dir, n_valid=args.n_valid),
    ...
    vaX, vaM = transform_sst2(vaX)
    if submit:
        teX, teM = transform_sst2(teX)
    ...
    if submit:
        ...
        if args.analysis:
            clas_analysis(data_dir, os.path.join(args.submission_dir, desc+'.tsv'),
